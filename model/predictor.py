        ...
        try:
            ...
            for feature in ["rsi", "macd", "macd_signal", "atr", "volume"]:
                if feature in df.columns:
                    # Convert to pd.Series explicitly to avoid numpy types
                    feature_series = pd.Series(df[feature].values, index=df.index, dtype="float32")
            ...
            # Calculate candlestick patterns as pd.Series
